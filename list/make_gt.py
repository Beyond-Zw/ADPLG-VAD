...
video_root = '/data2/Vision_Group/YZW/Datasets/XD_test/videos'   ## the path of test videos
feature_list = '/data2/Vision_Group/YZW/UR-DMU-XD-revise-new/list/XD_category_lists/XD_G_Test.list'
# the ground truth txt

gt_txt = '/data2/Vision_Group/YZW/UR-DMU-XD-revise-new/list/XD_annotations.txt'     ## the path of test annotations
...
np.save('../frame_label/XD_category_gt/XD_G_gt.npy', gt)